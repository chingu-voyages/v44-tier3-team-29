...
export default function Error404() {
  return (
    <Layout>
      <div className='mb-[100px] max-h-[100%] min-h-[70vh] flex flex-col p-2 justify-center items-center bg-error-cats-mobile bg-[center_bottom_50px] bg-contain bg-no-repeat md:bg-error-cats md:bg-center md:bg-auto'>
