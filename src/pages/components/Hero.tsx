...
export default function Hero() {
  return (
    <div className='h-full min-h-[600px] p-4 flex flex-col items-center sm:justify-center md:justify-center bg-hero-gradient bg-no-repeat bg-[center_top_-50px] bg-[length:1000px] md:bg-[center_top_-50px] lg:bg-[length:1200px] lg:bg-[center_top] mb-[150px]'>
