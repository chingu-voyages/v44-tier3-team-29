...
export default function Hero() {
  return (
    <div className='h-screen min-h-[600px] p-4 flex flex-col items-center md:justify-center bg-hero-gradient bg-no-repeat bg-[center_top] bg-[length:1500px] md:bg-[length:1000px] md:bg-[center_top_100px] lg:bg-[length:1300px] lg:bg-[center_top_150px] mb-[150px]'>
      <h2 className='text-center font-light text-7xl p-2 mt-[250px] md:mt-1'>
