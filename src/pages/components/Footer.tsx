...
export default function Footer() {
  return (
    <div className="p-4 flex justify-between border-t-2 border-gray absolute bottom-0 left-0 right-0">
      <Link href="/" className="mx-3 p-2">
        <SVGComponent
      ...
      <Link href="https://github.com/chingu-voyages/v44-tier3-team-29" className="m-2">
        <SVGComponent
